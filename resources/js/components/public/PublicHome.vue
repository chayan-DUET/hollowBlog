  ...
  <!-- Slider area -->
    <section class="slider_area row m0">
        <div class="slider_inner">
            <div data-thumb="/public/asset/images/slider-1.jpg" data-src="/public/asset/images/slider-1.jpg">
            ...
            <div data-thumb="/public/asset/images/slider-2.jpg" data-src="/public/asset/images/slider-2.jpg">
                <div class="camera_caption">
                   <div class="container">
                        <h5 class=" wow fadeInUp animated">Welcome to our</h5>
                        <h3 class=" wow fadeInUp animated" data-wow-delay="0.5s">CLEAN ,MODERN, MULTIPURPOSE THEME</h3>
        ...
        <div class="container">
            ...
            <div class="row about_row">
                ...
                <div class="col-md-5 col-sm-6 about_client">
                    <img src="/public/asset/images/about_client.jpg" alt="">
                </div>
            </div>
        </div>
    </section>
        ...
        <div class="container">
            ...
            <div class="row construction_iner">
                <div class="col-md-4 col-sm-6 construction">
                   <div class="cns-img">
                        <img src="/public/asset/images/cns-1.jpg" alt="">
                   </div>
                ...
                <div class="col-md-4 col-sm-6 construction">
                   <div class="cns-img">
                        <img src="/public/asset/images/cns-2.jpg" alt="">
                   </div>
                   <div class="cns-content">
                ...
                <div class="col-md-4 col-sm-6 construction">
                   <div class="cns-img">
                        <img src="/public/asset/images/cns-3.jpg" alt="">
                   </div>
                   <div class="cns-content">
        ...
        <div class="container">
            ...
            <div class="feature_row row">
                <div class="col-md-6 feature_img">
                    <img src="/public/asset/images/feature-man.jpg" alt="">
                </div>
                   ...
                   <div class="grid-sizer"></div>
                    <div class="single_facilities col-xs-4 p0 painting photography adversting">
                       <div class="single_facilities_inner">
                          	<img src="/public/asset/images/gallery/sv-1.jpg" alt="">
                    ...
                    <div class="single_facilities col-xs-4 p0 webdesign">
                       <div class="single_facilities_inner">
                          	<img src="/public/asset/images/gallery/sv-2.jpg" alt="">
                            <div class="gallery_hover">
                                <h4>Construction</h4>
                                <ul>
                                    <li><a href="#"><i class="fa fa-link" aria-hidden="true"></i></a></li>
                    ...
                    <div class="single_facilities col-xs-4 painting p0 photography branding">
                       <div class="single_facilities_inner">
                          	<img src="/public/asset/images/gallery/sv-3.jpg" alt="">
                            <div class="gallery_hover">
                                <h4>Construction</h4>
                                <ul>
                                    <li><a href="#"><i class="fa fa-link" aria-hidden="true"></i></a></li>
                    ...
                    <div class="single_facilities col-xs-4 p0 adversting webdesign adversting">
                       <div class="single_facilities_inner">
                          	<img src="/public/asset/images/gallery/sv-4.jpg" alt="">
                            <div class="gallery_hover">
                                <h4>Construction</h4>
                                <ul>
                                    <li><a href="#"><i class="fa fa-link" aria-hidden="true"></i></a></li>
                    ...
                    <div class="single_facilities col-xs-4 p0 painting adversting branding">
                       <div class="single_facilities_inner">
                          	<img src="/public/asset/images/gallery/sv-5.jpg" alt="">
                            <div class="gallery_hover">
                                <h4>Construction</h4>
                                <ul>
                                    <li><a href="#"><i class="fa fa-link" aria-hidden="true"></i></a></li>
                    ...
                    <div class="single_facilities col-xs-4 p0 webdesign photography magazine adversting">
                       <div class="single_facilities_inner">
                          	<img src="/public/asset/images/gallery/sv-6.jpg" alt="">
                            <div class="gallery_hover">
                                <h4>Construction</h4>
                                <ul>
                                    <li><a href="#"><i class="fa fa-link" aria-hidden="true"></i></a></li>
            ...
            <div class="row team_row">
                <div class="col-md-3 col-sm-6 wow fadeInUp">
                   <div class="team_membar">
                        <img src="/public/asset/images/team/tm-1.jpg" alt="">
                ...
                <div class="col-md-3 col-sm-6 wow fadeInUp" data-wow-delay="0.2s">
                   <div class="team_membar">
                        <img src="/public/asset/images/team/tm-2.jpg" alt="">
                        <div class="team_content">
                            <ul>
                                <li><a href="#"><i class="fa fa-facebook" aria-hidden="true"></i></a></li>
                                <li><a href="#"><i class="fa fa-twitter" aria-hidden="true"></i></a></li>
                ...
                <div class="col-md-3 col-sm-6 wow fadeInUp" data-wow-delay="0.3s">
                   <div class="team_membar">
                        <img src="/public/asset/images/team/tm-3.jpg" alt="">
                        <div class="team_content">
                            <ul>
                                <li><a href="#"><i class="fa fa-facebook" aria-hidden="true"></i></a></li>
                                <li><a href="#"><i class="fa fa-twitter" aria-hidden="true"></i></a></li>
                ...
                <div class="col-md-3 col-sm-6 wow fadeInUp" data-wow-delay="0.4s">
                   <div class="team_membar">
                        <img src="/public/asset/images/team/tm-4.jpg" alt="">
                        <div class="team_content">
                            <ul>
                                <li><a href="#"><i class="fa fa-facebook" aria-hidden="true"></i></a></li>
                                <li><a href="#"><i class="fa fa-twitter" aria-hidden="true"></i></a></li>
            ...
            <div class="testimonial_carosel">
                <div class="item">
                    <div class="media">
                        <div class="media-left">
                            <a href="#">
                                <img class="media-object" src="/public/asset/images/testimonial-2.jpg" alt="">
                            </a>
                        </div>
                        <div class="media-body">
                ...
                <div class="item">
                    <div class="media">
                        <div class="media-left">
                            <a href="#">
                                <img class="media-object" src="/public/asset/images/testimonial-3.jpg" alt="">
                            </a>
                        </div>
                        <div class="media-body">
                            <h4 class="media-heading">Emran Khan</h4>
                ...
                <div class="item">
                    <div class="media">
                        <div class="media-left">
                            <a href="#">
                                <img class="media-object" src="/public/asset/images/testimonial-1.jpg" alt="">
                            </a>
                        </div>
                        <div class="media-body">
    ...
    <section class="featured_works row" data-stellar-background-ratio="0.3">
        ...
        <div class="featured_gallery">
            <div class="col-md-3 col-sm-4 col-xs-6 gallery_iner p0">
                <img src="/public/asset/images/gallery/gl-1.jpg" alt="">
                <div class="gallery_hover">
            ...
            <div class="col-md-3 col-sm-4 col-xs-6 gallery_iner p0">
                <img src="/public/asset/images/gallery/gl-2.jpg" alt="">
                <div class="gallery_hover">
                    <h4>Bolt Apartments</h4>
                    <a href="#">VIEW PROJECT</a>
                </div>
            ...
            <div class="col-md-3 col-sm-4 col-xs-6 gallery_iner p0">
                <img src="{/public/asset/images/gallery/gl-3.jpg" alt="">
                <div class="gallery_hover">
                    <h4>Bolt Apartments</h4>
                    <a href="#">VIEW PROJECT</a>
                </div>
            ...
            <div class="col-md-3 col-sm-4 col-xs-6 gallery_iner p0">
                <img src="{/public/asset/images/gallery/gl-4.jpg" alt="">
                <div class="gallery_hover">
                    <h4>Bolt Apartments</h4>
                    <a href="#">VIEW PROJECT</a>
                </div>
            ...
            <div class="col-md-3 col-sm-4 col-xs-6 gallery_iner p0">
                <img src="{/public/asset/images/gallery/gl-5.jpg" alt="">
                <div class="gallery_hover">
                    <h4>Bolt Apartments</h4>
                    <a href="#">VIEW PROJECT</a>
                </div>
            ...
            <div class="col-md-3 col-sm-4 col-xs-6 gallery_iner p0">
                <img src="{/public/asset/images/gallery/gl-6.jpg" alt="">
                <div class="gallery_hover">
                    <h4>Bolt Apartments</h4>
                    <a href="#">VIEW PROJECT</a>
                </div>
            ...
            <div class="col-md-3 col-sm-4 col-xs-6 gallery_iner p0">
                <img src="{/public/asset/images/gallery/gl-7.jpg" alt="">
                <div class="gallery_hover">
                    <h4>Bolt Apartments</h4>
                    <a href="#">VIEW PROJECT</a>
                </div>
            ...
            <div class="col-md-3 col-sm-4 col-xs-6 gallery_iner p0">
                <img src="{/public/asset/images/gallery/gl-8.jpg" alt="">
                <div class="gallery_hover">
                    <h4>Bolt Apartments</h4>
                    <a href="#">VIEW PROJECT</a>
                </div>
        ...
        <div class="container">
            ...
            <div class="row latest_blog">
                <div class="col-md-4 col-sm-6 blog_content">
                    <img src="{/public/asset/images/blog/lb-1.jpg" alt="">
                ...
                <div class="col-md-4 col-sm-6 blog_content">
                    <img src="{/public/asset/images/blog/lb-2.jpg" alt="">
                    <a href="#" class="blog_heading">Our Latest Project</a>
                    <h4><small>by  </small><a href="#">Prodip Ghosh</a><span>/</span><small>ON </small> October 15, 2016</h4>
                    <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Etiam sagittis iaculis velit in tristique. Curabitur ac urna urna. Sed sollicitudin at nisi sed accumsan... <a href="#">Read More</a></p>
                </div>
                <div class="col-md-4 col-sm-6 blog_content">
                    <img src="{/public/asset/images/blog/lb-3.jpg" alt="">
                    <a href="#" class="blog_heading">Our Latest Project</a>
                    <h4><small>by  </small><a href="#">Prodip Ghosh</a><span>/</span><small>ON </small> October 15, 2016</h4>
                    <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Etiam sagittis iaculis velit in tristique. Curabitur ac urna urna. Sed sollicitudin at nisi sed accumsan... <a href="#">Read More</a></p>
                </div>
    ...
    <section class="our_partners_area">
        <div class="container">
            ...
            <div class="partners">
                <div class="item"><img src="/public/asset/images/client_logo/client_logo-1.png" alt=""></div>
                <div class="item"><img src="/public/asset/images/client_logo/client_logo-2.png" alt=""></div>
                <div class="item"><img src="/public/asset/images/client_logo/client_logo-3.png" alt=""></div>
                <div class="item"><img src="/public/asset/images/client_logo/client_logo-4.png" alt=""></div>
                <div class="item"><img src="/public/asset/images/client_logo/client_logo-5.png" alt=""></div>
            </div>
        </div>
